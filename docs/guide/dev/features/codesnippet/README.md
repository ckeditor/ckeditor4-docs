...
<info-box hint="">
    You can preview themes in the {@linkexample codesnippet "Inserting Code Snippets" sample}. You can also browse them on the <a href="http://highlightjs.org/static/test.html">highlight.js demo page</a>.
</info-box>
...
For a complete list of available themes see the {@linkexample codesnippet Inserting Code Snippets sample} or the [highlight.js's demo page](http://highlightjs.org/static/test.html).
