...
Examples:
	...
	// A rule accepting <img> with a required "src" attribute and an optional "alt" attribute plus optional "width" and "height" styles.
...
For the convenience of the users Allowed Content Rules can be defined as a standard
...
With this approach, Allowed Content Rules can be dynamically generated by JavaScript
or stored for any purposes in JSON data format. Note that keys of object literals
**must be unique**, so:
