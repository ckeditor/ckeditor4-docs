...
CKEditor 4 offers great support for High Contrast, limited to Firefox, Internet Explorer and Edge (other browsers don't support High Contrast).  When enabled, the editor is rendered as clear lines and the toolbar buttons present text labels, instead of icon images.
