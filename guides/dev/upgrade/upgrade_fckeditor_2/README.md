...
The best option is to [download the latest CKEditor version](http://ckeditor.com/download) and install it, starting anew, as described in our [Quick Start Guide](#!/guide/dev_installation).
