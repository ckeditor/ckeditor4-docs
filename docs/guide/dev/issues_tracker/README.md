...
* Resolution labels &mdash; how and why the issue was resolved:
    ...
    * <span style="background-color:#444444;color:#FFF;padding:0 3px 0 3px">resolution:unsupported-env</span> &ndash; This issue can be reproduced on an unsupported environment.
