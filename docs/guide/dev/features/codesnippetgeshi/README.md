...
Go to your {@link guide/dev/configuration/README CKEditor configuration} and set the CKEDITOR.config.codeSnippetGeshi_url option. For example for in-page configuration you can use the following code:
