...
At the end of the day, **CKEditor is an editor &mdash; nothing more, nothing less**. Visit the {@linksdk index CKEditor Examples} to see plenty of valid editor use cases, with source code ready to copy and implement in your own solution!
