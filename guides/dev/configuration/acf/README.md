...
It is possible to manually specify allowed tags or properties through {@linkapi CKEDITOR.config.allowedContent CKEDITOR.config.allowedContent} To do this right, it is recommended you get familiar with the section about ACF in the [CKEditor Deep Dive](#!/guide/dev_advanced_content_filter) section.
